        ...
        >
          ...
          <div className="flex flex-col mb-4 items-start bg-white rounded-sm md:flex-row md:w-full">
            <Image
              ...
              width={500}
              height={300}
              className="object-cover w-full h-60 md:w-1/3 md:h-auto rounded-t-sm md:rounded-none md:rounded-s-sm"
            />
            <div className="flex items-center gap-1 mb-3 font-normal text-gray-700 ml-3 mr-3 w-full">
