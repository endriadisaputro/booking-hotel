            ...
            <div className="flex flex-col items-center justify-center text-gray-500 pt-5 pb-6 z-10">
              ...
              {image ? (
                <button
                  ...
                  className="flex items-center justify-center bg-red-400 size-6 rounded-sm absolute top-1 right-1 text-white hover:bg-red-500 cursor-pointer"
                >
                ...
                <div className="flex flex-col items-center justify-center">
                  ...
                  {message ? (
                    ...
                    <p className="text-xs">
                      PNG, JPG, JPEG, GIF, or other (max:4MB)
                    </p>
                  )}
                </div>
              )}
