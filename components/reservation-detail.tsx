...
const ReservationDetail = async ({
  ...
  return (
    <div className="w-full p-4 bg-white border border-gray-200 rounded-md shadow">
        ...
        <ul>
          ...
          <li className="py-2">
            <div className="flex items-center">
              ...
              <div className="inline-flex capitalize items-center text-base font-semibold text-gray-900">
        ...
        <table className="w-full text-sm text-left text-gray-500 ">
          <thead className="text-xs text-gray-700 uppercase bg-gray-50 ">
            <tr>
              ...
              <th className="px-6 py-3 min-w-60 md:min-w-0">Check-in</th>
